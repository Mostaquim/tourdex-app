...
function clickfeature(e) {
    document.getElementById('companyName').innerHTML = e.target.feature.properties.Company;
    document.getElementById('modal_image').src = './heroimage/' + e.target.feature.properties.image;
    $('#firstModal').modal('show');
    if (currentLang === 'en') {
        document.getElementById('description').innerHTML = e.target.feature.properties.Descriptonen;
    }
    document.getElementById('videoFrame').src = 'https://www.youtube.com/embed/' + e.target.feature.properties.videourl;
}
...
var points = L.geoJSON(_geojson2.default, {
...
info.onAdd = function (map) {
    this._div = L.DomUtil.create('div', 'dropdown'); // create a div with a class "info"
    var dropbtn = L.DomUtil.create('button', 'dropbtn');
    dropbtn.innerHTML = "Language";
    this._div.appendChild(dropbtn);
    var dropcontent = L.DomUtil.create('div', 'dropdown-content');

    lang.forEach(function (i) {

        var link = L.DomUtil.create('a', 'langlink');
        link.href = '#';
        link.innerHTML = i;
        link.id = i;
    ...
    this._div.appendChild(dropcontent);

    return this._div;
};
info.addTo(map);
// method that we will use to update the control based on feature properties passed
var details = L.control({ postion: 'topright' });
